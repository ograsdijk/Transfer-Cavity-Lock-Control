...
class LaserControl:
	...
	def __init__(self,parent,stat,laser,config_wvl=None):
		...
		self.adjustment_frame=LabelFrame(parent,text="Adjustment",bg=bg_color)
		...
		self.settings_frame=LabelFrame(parent,text="Settings",bg=bg_color)
		...
		Label(self.settings_frame,text="{0:.2f}".format(self.min_wv)+" nm",font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=1,column=3,sticky=E)
		Label(self.settings_frame,text="{0:.2f}".format(self.max_wv)+" nm",font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=1,column=7,sticky=E)
		...
		Label(self.settings_frame,text="{0:.3f}".format(self.c/self.min_wv)+" THz",font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=3,column=3,sticky=E)
		Label(self.settings_frame,text="{0:.3f}".format(self.c/self.max_wv)+" THz",font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=3,column=7,sticky=E)



		#Subframe - readout
		self.readout_frame=LabelFrame(parent,text="Readout",bg=bg_color)
		...
		self.set_lam=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=info_color)
		self.set_lam.grid(row=3,column=5,sticky=E)
		self.set_freq=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=info_color)
		self.set_freq.grid(row=5,column=5,sticky=E)
		self.set_lamu=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=info_color)
		self.set_lamu.grid(row=7,column=5,sticky=E)
		self.set_frequ=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=info_color)
		self.set_frequ.grid(row=9,column=5,sticky=E)

		self.lam=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
		self.lam.grid(row=3,column=3,sticky=E)
		self.freq=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
		self.freq.grid(row=5,column=3,sticky=E)
		self.lamu=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
		self.lamu.grid(row=7,column=3,sticky=E)
		self.frequ=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
		self.frequ.grid(row=9,column=3,sticky=E)
		self.pow=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
		self.pow.grid(row=11,column=3,sticky=E)
		self.temp=Label(self.readout_frame,text="",font="Arial 10",bg=bg_color,fg=num_color)
...
class TransferCavity:
	...
	def __init__(self,parent,plt_frame,lasers,config,simulate):
		...
		Label(self.cavity_window_readout,text="Error rms [ms]:",font="Arial 10 bold",bg=bg_color,fg=label_fg_color).grid(row=7,column=5,sticky=W)
		...
		self.real_lckp=Label(self.cavity_window_readout,text='{:.0f}'.format(self.lock.master_lockpoint), font="Arial 10 bold",fg=num_color,bg=bg_color)
	...
	def open_cav_settings(self):
		...
		Label(self.adset_window,text="RMS Master Lock Threshold [ms]:",font="Arial 10 bold",bg=bg_color,fg=label_fg_color).grid(row=11,column=1,sticky=W)
		...
		Label(self.adset_window,text="{:.3f}".format(self.transfer_lock.master_rms_crit)+" ms",font="Arial 10 bold",bg=bg_color,fg=inftext_color).grid(row=11,column=5,sticky=E)
		...
		if self.mlog_filename is not None:
			Label(self.adset_window,text=self.mlog_filename,font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=17,column=5,sticky=E)
		else:
			Label(self.adset_window,text="default",font="Arial 10 bold",bg=bg_color,fg=inftext_color).grid(row=17,column=5,sticky=E)
	...
	def open_las_settings(self,ind):
		...
		if self.laslog_filenames[ind] is not None:
			Label(self.adset_window,text=self.laslog_filenames[ind],font="Arial 10",bg=bg_color,fg=inftext_color).grid(row=13,column=5,sticky=E)
		else:
			Label(self.adset_window,text="default",font="Arial 10 bold",bg=bg_color,fg=inftext_color).grid(row=13,column=5,sticky=E)
